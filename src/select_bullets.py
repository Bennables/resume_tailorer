...
_INSTRUCTIONS = (
    ...
    "3. Keyword breadth: when choosing between bullets of similar strength, prefer "
    "the one that introduces JD keywords/phrases not yet covered by already-selected "
    "bullets. Maximize the count of distinct JD terms appearing across the final "
    "selection — ATS systems score on keyword coverage, so each new term added is "
    "more valuable than reinforcing one already present.\n"
    "4. Concrete metrics alone, even without keyword overlap.\n"
